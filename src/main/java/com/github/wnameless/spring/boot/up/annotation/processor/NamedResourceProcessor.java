...
@SupportedAnnotationTypes("com.github.wnameless.spring.boot.up.annotation.processor.NamedResource")
    ...
    public boolean process(Set<? extends TypeElement> annotations,
        ...
        for (TypeElement annotation : annotations) {
            ...
            for (Element element : annotatedElements) {
                ...
                upperCamelSingular =
                        CaseFormat.valueOf(nr.singular().type().toString())
                                .to(CaseFormat.UPPER_CAMEL, singularName);
                lowerCamelSingular = CaseFormat.UPPER_CAMEL
                        .to(CaseFormat.LOWER_CAMEL, upperCamelSingular);
                upperUnderscoreSingular = CaseFormat.UPPER_CAMEL
                        .to(CaseFormat.UPPER_UNDERSCORE, upperCamelSingular);
                lowerUnderscoreSingular = CaseFormat.UPPER_CAMEL
                        .to(CaseFormat.LOWER_UNDERSCORE, upperCamelSingular);
                lowerHyphenSingular = CaseFormat.UPPER_CAMEL
                        .to(CaseFormat.LOWER_HYPHEN, upperCamelSingular);

                upperCamelPlural =
                        CaseFormat.valueOf(nr.plural().type().toString())
                                .to(CaseFormat.UPPER_CAMEL, pluralName);
                lowerCamelPlural = CaseFormat.UPPER_CAMEL
                        .to(CaseFormat.LOWER_CAMEL, upperCamelPlural);
                upperUnderscorePlural = CaseFormat.UPPER_CAMEL
                        .to(CaseFormat.UPPER_UNDERSCORE, upperCamelPlural);
                lowerUnderscorePlural = CaseFormat.UPPER_CAMEL
                        .to(CaseFormat.LOWER_UNDERSCORE, upperCamelPlural);
                lowerHyphenPlural = CaseFormat.UPPER_CAMEL
                        .to(CaseFormat.LOWER_HYPHEN, upperCamelPlural);
                ...
                builder.addField(FieldSpec.builder(String.class, "SINGULAR")
                        ...
                        .addField(FieldSpec
                                .builder(String.class, "UPPER_CAMEL_SINGULAR")
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                                .initializer("$S", upperCamelSingular).build())
                        // LOWER_CAMEL_SINGULAR
                        .addField(FieldSpec
                                .builder(String.class, "LOWER_CAMEL_SINGULAR")
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                        ...
                        .addField(FieldSpec
                                ...
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                                .initializer("$S", upperUnderscoreSingular)
                                .build())
                        ...
                        .addField(FieldSpec
                                ...
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                                .initializer("$S", lowerUnderscoreSingular)
                                .build())
                        // LOWER_HYPHEN_SINGULAR
                        .addField(FieldSpec
                                .builder(String.class, "LOWER_HYPHEN_SINGULAR")
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                        ...
                        // UPPER_CAMEL_PLURAL
                        .addField(FieldSpec
                                .builder(String.class, "UPPER_CAMEL_PLURAL")
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                                .initializer("$S", upperCamelPlural).build())
                        // LOWER_CAMEL_PLURAL
                        .addField(FieldSpec
                                .builder(String.class, "LOWER_CAMEL_PLURAL")
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                        ...
                        .addField(FieldSpec
                                ...
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                                .initializer("$S", upperUnderscorePlural)
                                .build())
                        ...
                        .addField(FieldSpec
                                ...
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                                .initializer("$S", lowerUnderscorePlural)
                                .build())
                        // LOWER_HYPHEN_PLURAL
                        .addField(FieldSpec
                                .builder(String.class, "LOWER_HYPHEN_PLURAL")
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC,
                                        Modifier.FINAL)
                    ...
                    switch (nameType) {
                        case LOWER_CAMEL:
                            builder.addField(FieldSpec
                                    .builder(String.class, lowerCamelSingular)
                                    .addModifiers(Modifier.PUBLIC,
                                            Modifier.STATIC, Modifier.FINAL)
                                    .initializer("$S", lowerCamelSingular)
                                    .build());
                            break;
                        ...
                        case UPPER_CAMEL:
                            builder.addField(FieldSpec
                                    .builder(String.class, upperCamelSingular)
                                    .addModifiers(Modifier.PUBLIC,
                                            Modifier.STATIC, Modifier.FINAL)
                                    .initializer("$S", upperCamelSingular)
                                    .build());
                            break;
                ...
                for (NameType nameType : nr.literalPluralConstants()) {
                    switch (nameType) {
                        case LOWER_CAMEL:
                            builder.addField(FieldSpec
                                    .builder(String.class, lowerCamelPlural)
                                    .addModifiers(Modifier.PUBLIC,
                                            Modifier.STATIC, Modifier.FINAL)
                                    .initializer("$S", lowerCamelPlural)
                                    .build());
                            break;
                        case LOWER_UNDERSCORE:
                            builder.addField(FieldSpec
                        ...
                        case UPPER_CAMEL:
                            builder.addField(FieldSpec
                                    .builder(String.class, upperCamelPlural)
                                    .addModifiers(Modifier.PUBLIC,
                                            Modifier.STATIC, Modifier.FINAL)
                                    .initializer("$S", upperCamelPlural)
                                    .build());
                            break;
                        case UPPER_UNDERSCORE:
                            builder.addField(FieldSpec

...
public interface ResourceAbility extends Ability {
  ...
  public static ResourceAbility ofResource(Class<?> resourceType,
      String abilityName,
      ResourceFilterRepository<?, ?> resourceFilterRepository) {
    return new SimpleResourceAbility(resourceType, abilityName,
  ...
  public static ResourceAbility ofEmbeddedResource(Class<?> resourceType,
  ...
  public static ResourceAbility ofEmbeddedResource(Class<?> resourceType,
      String fieldName, Ability ability,
      EmbeddedResourceFilterRepository<?, ?, ?> embeddedResourceFilterRepository) {
    return new SimpleResourceAbility(resourceType, fieldName,
        ability.getAbilityName(), embeddedResourceFilterRepository);
  }
